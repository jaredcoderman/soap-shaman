...
const Footer = () => {
  return (
    <div className="pb-14 bg-black text-white">
      <div className="pt-14 w-3/4 gap-6 grid grid-cols-3 mx-auto">
        <div className="col-span-2">
          ...
          <div className="mt-4 grid grid-cols-10">
            <h2 className="font-light py-4 pl-4 col-span-6 border-1 border-white">
              jared@jheadwebconsulting.com
            </h2>
            <h2 className="text-center py-4 col-span-2 border-1 border-white font-light">
              Subscribe
            </h2>
          </div>
        </div>
        <div className="col-span-1 gap-12 grid grid-cols-2">
          <div>
